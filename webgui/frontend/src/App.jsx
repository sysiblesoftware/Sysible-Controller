...
// Sections opened from the sidebar. Titles mirror the desktop.
const SECTIONS = {
  hosts: "Host Enrollment",
  sysadmin: "System Administration",
  connect: "Sysible Connect",
  live: "Live Activity & Logs",
  portal: "Webserver Portal",
  settings: "Settings",
};
...
const NAV = [
  ...
  { key: "portal", label: "Webserver Portal", icon: "globe", su: true },
    ...
    <div className="shell">
      <nav className="rail">
        ...
        <div className="rail-footer">
          {badge && <div className="rail-edition">{badge}</div>}
      ...
      <main className="main">
        <div className="main-top">
          ...
          <div className="main-top-sub">
            {view ? "" : `Signed in as ${user}${role ? ` · ${role}` : ""}`}
          </div>
        </div>
